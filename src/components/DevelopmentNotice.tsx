  ...
  return (
    <Collapse in={open}>
      <Box
        sx={{
          background:
            "linear-gradient(90deg, rgba(255, 152, 0, 0.15) 0%, rgba(255, 193, 7, 0.15) 100%)",
      ...
      >
        ...
        >
          <Box component="span">
            <strong>🚧 Active Development</strong> — This website is under
            active development. Expect bugs, visual quirks, and occasional
            disruptions.
          </Box>
        </Alert>
      </Box>
