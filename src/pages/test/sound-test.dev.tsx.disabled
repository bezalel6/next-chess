...
export default function SoundTestPage() {
  ...
  const playAllSounds = async () => {
    const soundKeys = Object.keys(CHESS_SOUNDS) as Array<
      keyof typeof CHESS_SOUNDS
    >;
        ...
        >
          ...
          <Box sx={{ mb: 4, p: 2, bgcolor: "#1e1a17", borderRadius: 1 }}>
            <Typography variant="body2" sx={{ color: "#888" }}>
              ...
              <span
                style={{
                  color: currentlyPlaying ? "#4caf50" : "#bababa",
                  fontWeight: 600,
                }}
              >
                {currentlyPlaying
                  ? SOUND_DESCRIPTIONS[
                      currentlyPlaying as keyof typeof CHESS_SOUNDS
                    ]
                  : "None"}
              </span>
            </Typography>
            <Typography variant="body2" sx={{ color: "#888", mt: 1 }}>
              ...
              <span style={{ color: "#bababa" }}>
                {lastPlayed
                  ? SOUND_DESCRIPTIONS[lastPlayed as keyof typeof CHESS_SOUNDS]
                  : "None"}
              </span>
            </Typography>
          </Box>
          ...
          <Grid container spacing={2}>
            {(
              Object.keys(CHESS_SOUNDS) as Array<keyof typeof CHESS_SOUNDS>
            ).map((soundKey) => (
              <Grid item xs={12} sm={6} md={4} key={soundKey}>
                <Button
                  ...
                  sx={{
                    color:
                      currentlyPlaying === soundKey ? "#4caf50" : "#bababa",
                    borderColor:
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                ...
                <Typography variant="body2" sx={{ color: "#888", pl: 2 }}>
                  ...
                  <br />
                  • Promote - Pawn reaching the back rank
                  <br />• Check - When putting opponent in check
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography variant="body2" sx={{ color: "#888", mb: 1 }}>
                ...
                <Typography variant="body2" sx={{ color: "#888", pl: 2 }}>
                  • Game Start - Beginning of a new game
                  <br />
                  • Game End - Checkmate or game over
                  <br />
                  • Ban Move - Ban Chess variant move ban
                  <br />
                  • Opponent Move - Opponent makes a move
                  <br />• Ten Seconds - Time warning alert
                </Typography>
              </Grid>
            </Grid>
          </Box>
